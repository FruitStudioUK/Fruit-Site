...
export default function TermsAndServices() {
  ...
  Privacy Policy
          ...
          <section className="space-y-4">
            ...
            <p>
              You may not reverse-engineer, decompile, or otherwise attempt to discover the underlying code or technology of the Website. You may not remove, obscure, or alter any proprietary notices, labels, or marks on the Website.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              You agree not to use the Website for any unlawful, abusive, or harmful purpose, including but not limited to:
            </p>
            <p>
              - Uploading or transmitting viruses, malware, or harmful code;
            </p>
            <p>
              - Engaging in harassment, discrimination, or defamation;
            </p>
            <p>
              - Spamming, phishing, or attempting to gain unauthorized access;
            </p>
            <p>
              - Violating any third-party intellectual property, privacy, or publicity rights;
            </p>
            <p>
              - Posting illegal, obscene, or otherwise objectionable content;
            </p>
            <p>
            ...
            <p>
              - Copying or scraping Website content for commercial purposes without permission;
            </p>
            <p>
          ...
          <section className="space-y-4">
            ...
            <p>
              This limitation does not apply to liability for death, personal injury, fraud, gross negligence, or willful misconduct.
            </p>
          </section>
