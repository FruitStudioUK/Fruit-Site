            ...
            {[
              {
                ...
                bio: 'Former Marketing & Sales Director with experience in brand growth and campaign management.'
              },
              {
                name: 'Dev Buchiti',
                role: 'Partnerships Director',
                image: 'https://i.postimg.cc/J4wkPhR3/image-2025-08-15-143606477.png',
                bio: 'Ex-Social Media partnerships manager who has facilitated double digits in brand collaborations.'
              },
              {
                name: 'Emily Taylor',
                role: 'Senior Campaign Producer',
                image: 'https://i.postimg.cc/KzMYMnk6/image-2024-08-19-181207250.png',
                bio: 'Professional producer specializing in high-impact brand campaigns and social media optimization.'
              }
            ].map((member, index) => (
