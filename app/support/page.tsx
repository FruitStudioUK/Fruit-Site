        ...
        <div className="container-max">
          <div className="text-center max-w-4xl mx-auto animate-fade-in">
            ...
            <p className="text-xl text-text-gray mb-8 leading-relaxed">
              ...
              Enjoy lower management fees on your first campaign, 24/7 communication, and daily analytical reports 
            ...
            {[
              {
                ...
                answer: 'We offer low management fees on your first campaign and a test-piloy on your first deal. You also get daily analytical reports, 24/7 communication, and guaranteed ROI‑driven deliverables like a free pinned YouTube comment.'
              },
              {
              ...
              },
              {
                ...
                answer: 'We match you with only creators that promote tech brands like yours. For example, your first campaign includes 1-3 Creators and 1-3 high‑quality videos as part of our USP.'
              },
              {
              ...
              },
              {
                ...
                answer: 'Transparent pricing covers campaign management, creator deliverables, and reporting. With no hidden fees, you only pay for results.'
              },
              {
